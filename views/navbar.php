       ...
       <?php
            if (!isset($_SESSION["session"])) {
              ...
              <a class="btn btn-success" href="">
                <svg xmlns="http://www.w3.org/2000/svg" width="50" height="22" fill="currentColor" class="bi bi-chat-dots" viewBox="0 0 16 16">
              ...
              <a class="btn btn-danger" href="likes.php">
                <svg xmlns="http://www.w3.org/2000/svg" width="50" height="18" fill="currentColor" class="bi bi-heart-fill" viewBox="0 0 16 16">
